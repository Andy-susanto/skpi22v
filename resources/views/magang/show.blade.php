...
@section('content_header')
    <h1 class="m-0 text-dark"><span><a name="" id="" class="btn btn-default btn-sm"
                href="{{ route('kegiatan.form', $data->ref_jenis_kegiatan_id) }}" role="button">Kembali</a></span> Magang
        Detail</h1>
@stop
@section('content')
    <div class="row">
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $data->relasi->alamat }}</td>
                            </tr>
                            <tr>
                                <td>Bidang</td>
                                <td>:</td>
                                <td>{{ $data->relasi->bidang->nama }}</td>
                            </tr>
                            <tr>
                                <td>Divisi</td>
                                <td>:</td>
                                <td>{{ $data->relasi->divisi->nama }}</td>
                            </tr>
                            <tr>
