...
@section('content_header')
    <div class="row">
        <div class="mb-3 col-12">
            <h1 class="m-0 font-bold text-dark uppercase"><i class="fa fa-bookmark" aria-hidden="true"></i> Publikasi
            </h1>
        </div>
    </div>
@stop
                        ...
                        <div class="col-12">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab2" role="tablist">
                                    <a class="font-bold nav-link active" id="nav-publikasi-tab-index" data-toggle="tab"
                                        href="#nav-home2" role="tab">PUBLIKASI</a>
                                </div>
                            </nav>
                        ...
                        <div class="col-md-12">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab3" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-publikasi-tab-show" data-toggle="tab"
                                        href="#nav-home3" role="tab" aria-controls="nav-home"
                                        aria-selected="true">PUBLIKASI</a>
                                </div>
                            </nav>
                            <div class="tab-content" id="nav-tabContent">
                                @include('karya-mahasiswa.include.show-publikasi', ['data' => $data])
                            </div>
                        </div>
                    </div>
                </div>
