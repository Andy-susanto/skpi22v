                     ...
                     <table class="table table-bordered">
                         ...
                         <tbody>
                             <tr>
                                 ...
                                 <td>{{ Helper::hitung_bobot('pengabdian') }}</td>
                             </tr>
                             <tr>
                                 <td colspan="3">
                                     <div class="progress">
                                         <div class="progress-bar progress-bar-striped progress-bar-animated"
                                             role="progressbar" aria-valuenow="{{ Helper::hitung_bobot('pengabdian') }}"
                                             aria-valuemin="0" aria-valuemax="100"
                                             style="width: {{ (Helper::hitung_bobot('pengabdian') / Helper::min_bobot()) * 100 }}%">
                                             Proses
                                             Bobot : {{ Helper::hitung_bobot('pengabdian') }}/{{ Helper::min_bobot() }}</div>
                                     </div>
                                 </td>
                                 </td>
                             </tr>
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu" aria-labelledby="triggerId">
                                                                 ...
                                                                 @if (in_array($data->status_validasi, ['3', '2']))
                                                                     <a class="dropdown-item"
                                                                         href="{{ route('pengabdian-masyarakat.edit', encrypt($data->id_pengabdian_masyarakat)) }}"><i
                                                                             class="fas fa-edit" aria-hidden="true"></i>
                                                                         Ubah</a>
                                                                     <a class="dropdown-item" href="#"
                                                                         onclick="destroy('hapusData{{ $data->id_pengabdian_masyarakat }}')"><i
                                                                             class="fas fa-trash" aria-hidden="true"></i>
                                                                         Hapus
                                                                     </a>
                                                                     <form method="post"
                                                                         action="{{ route('pengabdian-masyarakat.destroy', encrypt($data->id_pengabdian_masyarakat)) }}"
                                                                         id="hapusData{{ $data->id_pengabdian_masyarakat }}">
                                                                         @csrf
                                                                         @method('delete')
                                                                     </form>
                                                                 @endif
