...
@section('content_header')
    <h1 class="m-0 text-dark"><span><a name="" id="" class="btn btn-default btn-sm"
                href="{{ route('kegiatan.lihat', $data->ref_jenis_kegiatan_id) }}" role="button"><i class="fa fa-arrow-left"
                    aria-hidden="true"></i>
                Kembali</a></span> Pengabdian Masyarakat Detail <a href="{{ route('kegiatan.edit', encrypt($data->id)) }}"
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <a href="{{ asset('storage/' . $data->file->path) }}" class="btn btn-sm btn-info"><i
                                            class="fa fa-paperclip" aria-hidden="true"></i> File Sertifikat</a>
                                    <a href="{{ asset('storage/' . $data->relasi->file_sk->path) }}"
                                        class="btn btn-sm btn-info"><i class="fa fa-paperclip" aria-hidden="true"></i> File
                                        SK</a>
                                </td>
                            </tr>
                        </tbody>
