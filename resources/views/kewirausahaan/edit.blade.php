...
@section('content_header')
    <h1 class="m-0 text-dark"><span><a name="" id="" class="btn btn-default btn-sm"
                href="{{ route('kegiatan.form', $data->ref_jenis_kegiatan_id) }}" role="button"><i class="fa fa-arrow-left"
                    aria-hidden="true"></i> Kembali</a></span> Ubah Kewirausahaan <button type="button"
    ...
    <div class="row">
        <div class="col-6 offset-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('kegiatan.update', encrypt($data->idd)) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_usaha" id=""
                                aria-describedby="helpId" placeholder="" value="{{ $data->relasi->nama_usaha }}">
                        </div>
                        <div class="form-group">
                            <label for="">Alamat Usaha</label>
                            <textarea class="form-control" name="alamat_usaha" id="" rows="3">{{ $data->relasi->alamat_usaha }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">No Izin</label>
                            <input type="text" class="form-control" name="no_izin" value="{{ $data->relasi->no_izin }}">
                        </div>
                        <div class="form-group">
