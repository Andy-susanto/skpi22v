                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $data->relasi->penyelenggara->nama_penyelenggara }}</td>
                            </tr>
                            <tr>
                                <td>Tingkat Kegiatan</td>
                                <td>:</td>
                                <td>{{ $data->relasi->tingkat->nama_tingkat }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Prestasi</td>
                                <td>:</td>
                                <td>{{ $data->relasi->prestasi->nama_prestasi }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $data->relasi->kepeg_pegawai->nip }} -
                                    {{ Helper::nama_gelar($data->relasi->kepeg_pegawai) }}</td>
                            </tr>
                            <tr>
