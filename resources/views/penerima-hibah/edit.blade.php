...
@section('content_header')
    <h1 class="m-0 text-dark"><span><a name="" id="" class="btn btn-default btn-sm"
                href="{{ route('kegiatan.lihat', $data->ref_jenis_kegiatan_id) }}" role="button"><i class="fa fa-arrow-left"
                    aria-hidden="true"></i>
                Kembali</a></span> Ubah Penerima Hibah <button type="button" class="btn btn-outline-primary btn-sm"><i
                    ...
                    <form action="{{ route('kegiatan.update', encrypt($data->id)) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama" id=""
                                aria-describedby="helpId" placeholder="" value="{{ $data->nama }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="kepeg_pegawai_id" id="dosen_pembimbing">
                                @if ($data->kepeg_pegawai()->exists())
                                    <option value="{{ $data->kepeg_pegawai->id_pegawai }}">
                                        ...
                                        {{ Helper::nama_gelar($data->kepeg_pegawai) }}</option>
                                @endif
                            </select>
                        </div>
                        <div class="form-group">
